...
export const getAllProjects = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://my-portfolio-2-0bi0.onrender.com/api/v1/project/getall",
...
export const addNewProject = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://my-portfolio-2-0bi0.onrender.com/api/v1/project/add",
      data,
      {
        withCredentials: true,
...
export const deleteProject = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://my-portfolio-2-0bi0.onrender.com/api/v1/project/delete/${id}`,
      {
        withCredentials: true,
      }
    );
...
export const updateProject = (id, newData) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://my-portfolio-2-0bi0.onrender.com/api/v1/project/update/${id}`,
      newData,
      {
        withCredentials: true,
        headers: { "Content-Type": "multipart/form-data" },
